...
import cn.ityun.com.carservice.adapter.AlbumGridViewAdapter;
import cn.ityun.com.carservice.mefragment.PostFragment;
import cn.ityun.com.carservice.util.AlbumHelper;
import cn.ityun.com.carservice.util.Bimp;
import cn.ityun.com.carservice.util.ImageBucket;
					...
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (Bimp.tempSelectBitmap.size() >= PublicWay.num) {
							...
							if (!removeOneData(dataList.get(position))) {
								Utils.showToast(AlbumActivity.this, Res.getString("only_choose_num"));
							}
							return;
						}
						if (isChecked) {
